...
public class HuanCunBean {
        ...
        @Generated(hash = 533835699)
        public HuanCunBean(double bargainPrice, String createtime, String detailUrl, String images, int pid, double price, String title) {
